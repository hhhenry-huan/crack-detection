...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='my_dates/mydata_5.yaml', help='model.yaml path')#修改处

    parser.add_argument('--data', type=str, default='my_dates/mydata.yaml', help='dataset.yaml path')#修改处
    parser.add_argument('--hyp', type=str, default='data/hyps/hyp.scratch.yaml', help='hyperparameters path')

    parser.add_argument('--epochs', type=int, default=400)#修改处，显卡低的可以调到100，原来是300
